...
var openFB = (function () {
	...
	/*var loginURL = 'fb://facebook.com/dialog/oauth',

        logoutURL = 'fb://facebook.com/logout.php',*/
    ...
    // Default Cordova OAuth redirect URL. Can be overriden in init()
       cordovaOAuthRedirectURL = "https://www.facebook.com/connect/login_success.html",
		/*cordovaOAuthRedirectURL = "fb://facebook.com/connect/login_success.html",*/
    ...
    function login(callback, options) {
        ...
        loginWindow = window.open(loginURL + '?client_id=' + fbAppId + '&redirect_uri=' + redirectURL +
            '&response_type=token&auth_type=reauthenticate&scope=' + scope, '_blank', 'location=no,clearcache=yes');
